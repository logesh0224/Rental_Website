...
import SellerDetails from './SellerDetails'; // Import the SellerDetails component
...
export type HotelFormData = {
  ...
  adultCount: number;
  childCount: number;
  sellerName: string; // Add seller details to the form data type
  sellerEmail: string;
...
const ManageHotelForm = ({ onSave, isLoading, hotel }: Props) => {
  ...
  const onSubmit = handleSubmit((formDataJson: HotelFormData) => {
    ...
    formData.append("sellerEmail", formDataJson.sellerEmail);
    formData.append("sellerPhoneNumber", formDataJson.sellerPhoneNumber);
    formData.append("sellerAddress", formDataJson.sellerAddress);
